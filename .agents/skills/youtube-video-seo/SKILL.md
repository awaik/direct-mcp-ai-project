...
Use when the user asks for YouTube title, description, tags, chapters, transcript cleanup, or SEO packaging.
...
Return a ready-to-publish package with alternatives and notes on the strongest angle.
