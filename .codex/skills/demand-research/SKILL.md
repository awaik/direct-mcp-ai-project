...
description: "Исследование поискового спроса и текущей семантики: упущенный спрос, сезонный прогноз бюджета, каннибализация ключевых, верификация интента. Для создания семантического ядра с нуля используй semantic-core."
---

# Demand Research — Исследование спроса и текущей семантики
...
Если задача — собрать семантическое ядро с нуля, задать вводные вопросы, построить структуру кампаний/кластеров/минусов под экономику и автостратегии, используй skill `semantic-core`. Этот skill подключай для аналитических подзадач: упущенный спрос, сезонность, каннибализация, проверка интента.
